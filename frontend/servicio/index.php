...
<head>
    ...
    <title>Mors Motors - Tabla de servicio</title>
    ...
    <table  class="table table-sm" border="2">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="../../backend/servicio/nuevo-servicio.php" class="btn btn-primary">Agregar</a></td>
      ...
      <a href="../../backend/servicio/nuevo-servicio.php" class="btn btn-primary">Agregar</a>
  </div>
</div>
